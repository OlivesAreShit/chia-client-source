...
public class ESP extends Module{
	...
	public void setup() {
		...
		Paradox.instance.settingsManager.rSetting(new Setting("Mob", this, false));
		Paradox.instance.settingsManager.rSetting(new Setting("Animal", this, false));
	}
	...
	public void onRender() {
		...
		if(this.isToggled() && Paradox.instance.settingsManager.getSettingByName("Mob").getValBoolean()) {
		...
		if(this.isToggled() && Paradox.instance.settingsManager.getSettingByName("Animal").getValBoolean()) {
