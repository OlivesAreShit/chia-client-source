...
public class Block
{
    ...
    {
    	//Paradox
    	if(this == Block.getBlockById(14)) //Gold
    		return true;
    	if(this == Block.getBlockById(15)) //Gold
    		return true;
    	if(this == Block.getBlockById(16)) //Gold
    		return true;
    	if(this == Block.getBlockById(21)) //Gold
    		return true;
    	if(this == Block.getBlockById(56)) //Gold
    		return true;
    	if(this == Block.getBlockById(73)) //Gold
    		return true;
    	if(this == Block.getBlockById(74)) //Gold
    		return true;
    	if(this == Block.getBlockById(129)) //Gold
    		return true;
    	if(this == Block.getBlockById(153)) //Gold
    		return true;
    	if(this == Block.getBlockById(8)) //Gold
    		return true;
    	if(this == Block.getBlockById(9)) //Gold
    		return true;
    	if(this == Block.getBlockById(10)) //Gold
    		return true;
    	if(this == Block.getBlockById(11)) //Gold
    		return true;
    	if(Xray.enabled)
    		return false;
